...
config :resolvd, ResolvdWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "pbgQai86g/3/b2+/ePckQcsEIJVF8SteTDvYt5oWLenFiOEcCxVo21/Sf2kl7AEH",
  watchers: [
...
config :resolvd, ResolvdWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/resolvd_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
