defmodule ResolvdWeb.Components.GlobalSearch do
  use ResolvdWeb, :live_component

  def render(assigns) do
    ~H"""
    <form class="relative flex flex-1" action="#" method="GET">
      <div class="w-full" phx-click={show_search()} phx-target={@myself}>
      ...
      <div id="super-search-container" class="hidden relative z-10" role="dialog" aria-modal="true">
        <!--
    ...
    -->
        ...
        <div id="super-search" class="hidden fixed inset-0 z-10 overflow-y-auto p-4 sm:p-6 md:p-20">
          <!--
