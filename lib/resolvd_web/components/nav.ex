      ...
      >
        ...
        <nav class="flex flex-1 flex-col">
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
                  ...
                  <.link
                    ...
                    class={[
                      ...
                      if(active_path(@view, item.module),
                        ...
                        else: "text-gray-800 hover:text-white hover:bg-gray-800"
                      )
                    ]}
                  >
                    <.icon
            ...
            <li>
              <div class="text-xs font-semibold leading-6 text-gray-800">
              ...
              <ul role="list" class="-mx-2 mt-2 space-y-1">
                <li>
                  ...
                  <a
                    href="#"
                    class="text-gray-800 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
                  >
                    <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-green-500 bg-green-600 text-[0.625rem] font-medium text-white">
                      H
                    </span>
                    <span class="truncate">Luke Strickland</span>
                  </a>
                </li>
                <li>
                  <a
                  ...
                  >
                    ...
                    <span class="truncate">Shelby Romanik</span>
                  </a>
                </li>
                <li>
                  <a
                  ...
                  >
                    ...
                    <span class="truncate">Geena Greguric</span>
                  </a>
                </li>
              </ul>
            </li>
            <li :if={@current_user.is_admin} class="mt-auto">
              <.link
                navigate={~p"/admin"}
                class={[
                  "group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold",
